...
//! \brief read settings from PC in standard order
//!	\details data types dont need to be different now as Due long and ints are the same (i think)
//!	but kept the same for ease of copy and pasting from Uno code :)
//! \param	number of injection - int
//!	\param number of electrodes - int
//!	\param number of frequencies - int
//!	\param number of repeated protcols - int
//!	\param ContactTime  uS - long - user sends ms
//!	\param Stimulator trigger time - us - user sends ms
//!	\param Stimulator trigger offset - us - - user sends ms
//!	\param Stimulator pulse width - long in uS - user sends us
//!	\param Stimulator wiper setting - int 8bit value 
//!	\param Source channels[NumInj] - int
//!	\param Sink channels[NumInj] - int
//!	\param Freq[NumFreq] - long
//!	\param Amp[NumFreq] - long
//!	\param Measurementtime[NumFreq] - long - user sends ms
