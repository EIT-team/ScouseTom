...
int NumBoard = 2; // number of Switching boards attached in daisy chain - starts at 1 for first call of Switch_init, then set by user
int TotalPins = 40 * NumBoard; // total number of pins available 
