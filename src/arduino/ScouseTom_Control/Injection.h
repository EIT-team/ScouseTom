...
const int NumShunt = 4; // the number of electrodes you want shunted together
const int NumPrt = 8; // the array needed to store the 8 values for protocol (4 sources, 4 sinks)
