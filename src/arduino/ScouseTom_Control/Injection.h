...
const int NumShunt = 8; // the number of electrodes you want shunted together
const int NumPrt = 16; // the array needed to store the 16 values for protocol (8 sources, 8 sinks)
