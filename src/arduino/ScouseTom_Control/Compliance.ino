...
//! \brief read bit from correct bit mask 
...
//! \brief reset all bits in compliance status masks to 0
...
//! \brief Reads all bit masks to see if any have any high bits in
...
//! \brief This checks for compliance and puts result in approprtiate place in bitmask.
