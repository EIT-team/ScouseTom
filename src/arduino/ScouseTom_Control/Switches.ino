...
void programswitches_shunt(int injchn[], int maxpins)
{
  ...
  int sourcechn[ NumShunt ] = {injchn[0], injchn[1], injchn[2], injchn[3], injchn[4], injchn[5], injchn[6], injchn[7]};
  
  int sinkchn[ NumShunt ] = {injchn[8], injchn[9], injchn[10], injchn[11], injchn[12], injchn[13], injchn[14], injchn[15]};
