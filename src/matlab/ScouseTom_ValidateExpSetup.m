...
yesresp='YES! ';
noresp= 'NO!';
titlestr='8 shunting mode!!';
promptstr='You want to be shunting 8 electrodes right?';
...
if size(ExpSetup.Protocol,2) ~= 16
    warning('Number of electrodes per protocol line needs to be 16');
    goodnessflag=0;
	return 
end
