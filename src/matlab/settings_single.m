...
ExpSetup.Repeats = 1 ; %dont change this squirrel
ExpSetup.Protocol =[1 2] ; %dont change this squirrel

%Experimental Parameters

% Runtime --> this in ms so 30,000 is 30 seconds
ExpSetup.MeasurementTime = 450000 ;

% this is in ms, and we want to set it to not a multiple of 50Hz 
ExpSetup.StimulatorTriggerTime = 1000; %998 ; % approx 1sec
...
%Digitimer - NL800 - C[urrent Settings (0 - 10 Volt input; > 2.56V);
ExpSetup.StimulatorVoltage = 10 ;
%NL800 maxes out at 10-Volts. 

% send settings to controllers and current source

%[Ard,ExpSetup,isok]=ScouseTom_SendSettings_CS2(Ard,ExpSetup,'COM8');
