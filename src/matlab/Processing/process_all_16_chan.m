...
%    end
   ...
   T_window = 0.04; % time to take around trigger
...
for iPair=1:Prt_size  
        ...
        bar(EIT{iPair}.BV0);
        title(['Pair  ' num2str(EIT{iPair}.Pair)]);
end
