function [ goodnessflag,ExpSetup ] = ScouseTom_ValidateExpSetup_4shunt( ExpSetup,VerboseFlag,varargin )
...
%write debug string
ExpSetup.Info.DebugString=ScouseTom_debugstring_4shunt(ExpSetup);
